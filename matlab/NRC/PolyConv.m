function p=PolyConv(a,b,c,d,e,f,g,h,i,j,k,l)
% function p=PolyConv(a,b,c,d,e,f,g,h,i,j)
% Recursively compute the convolution of the two to twelve polynomials, given as arguments.  
...
if nargin>11, a=PolyConv(a,l); end, if nargin>10, a=PolyConv(a,k); end
