...
%   TFnorm                - function x=TFnorm(A,B,C,[D],[p],[MODE])
...
%   CtrbGramian          - function [P,r] = CtrbGramian(A,B,[MODE])
%   CtrbGramianTest      - script <a href="matlab:CtrbGramianTest">CtrbGramianTest</a>
%   ObsvMatrix            - function [OM,r] = ObsvMatrix(A,C)
%   ObsvMatrixTest        - script <a href="matlab:ObsvMatrixTest">ObsvMatrixTest</a>
%   ObsvGramian          - function [Q,r] = ObsvGramian(A,C,[MODE])
%   ObsvGramianTest      - script <a href="matlab:ObsvGramianTest">ObsvGramianTest</a>
